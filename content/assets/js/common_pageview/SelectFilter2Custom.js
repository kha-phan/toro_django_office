// This is derived from SelectFilter2.js of Django project.

/*global SelectBox, gettext, quickElement, SelectFilter*/
/*
SelectFilter2Custom - Turns a multiple-select box into a filter interface.

Requires core.js, SelectBoxCustom.js and our custom file DetailPageControl.js
*/
'use strict';
{
    const detectSelectedAdminRole = function() {
        if (document.getElementById("div_id_clients")) {
            const clientForm = document.getElementById("div_id_clients");
            const selected = document.querySelectorAll('#id_groups_to option');
    ...
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            const title_chosen = quickElement('h2', selector_chosen, interpolate(gettext('Selected %s') + ' ', [field_name]));
        ...
        refresh_icons: function(field_id) {
            ...
            document.getElementById(field_id + '_add_link').parentNode.classList.toggle('active', SelectFilter.any_selected(from));
            document.getElementById(field_id + '_remove_link').classList.toggle('active', SelectFilter.any_selected(to));
            document.getElementById(field_id + '_remove_link').parentNode.classList.toggle('active', SelectFilter.any_selected(to));
